...
public class TjLocale {
    ...
    static {
        ...
        m.put("TjPlayerSpeed", "מהירות");
        m.put("TjPlayerLock", "נעילה");
        m.put("TjPlayerUnlock", "הקש לביטול הנעילה");
        m.put("TjPlayerEpisodes", "פרקים");
        m.put("TjPlayerAudioSubs", "שמע וכתוביות");
        m.put("TjPlayerAudio", "שמע");
        m.put("TjPlayerSubtitles", "כתוביות");
        m.put("TjPlayerSubtitlesOff", "כבויות");
        ...
        m.put("TjIdLookupRemoveChannel", "הסר מהערוץ הזה");
        m.put("TjIdLookupIsChannel", "ערוץ");
        m.put("TjIdLookupIsGroup", "קבוצה");
        m.put("TjIdLookupYouAdmin", "אתה מנהל");
        m.put("TjIdLookupCopyChatLink", "העתק קישור לצ'אט");
        m.put("TjIdLookupRemoveConfirm", "להסיר את %1$s מ-%2$s?");
        m.put("TjIdLookupRemoveConfirmAgain", "אי אפשר לבטל את זה. להסיר?");
        m.put("TjIdLookupRemoveAllConfirm", "להסיר את %1$s מכל %2$d הצ'אטים המשותפים?");
        m.put("TjIdLookupRemoveAllConfirmAgain", "כולם בבת אחת. בטוח?");
        m.put("TjIdLookupRemoveAllConfirmFinal", "הזדמנות אחרונה. להסיר אותו מכולן?");
        m.put("TjIdLookupRemoved", "הוסר");
        m.put("TjIdLookupNoRights", "אתה לא מנהל שם");
        m.put("TjIdLookupSearching", "מחפש…");
        m.put("TjAccountLogNoWriting", "אי אפשר לשלוח כאן הודעות");
        ...
        m.put("TjAccountLogClear", "ניקוי היומן");
        m.put("TjAccountLogClearInfo", "לשכוח את כל מה שרשום כאן?");
        m.put("TjAccountLogTypes", "מה לרשום");
        m.put("TjAccountLogTypeAdmin", "הרשאות ניהול");
        m.put("TjAccountLogTypeRestricted", "הגבלות");
        m.put("TjAccountLogTypeMembership", "הצטרפות ועזיבה");
        m.put("TjAccountLogTypeDevice", "מכשירים חדשים");
        m.put("TjAccountLogAdminGranted", "קיבלת הרשאות ניהול");
        m.put("TjAccountLogAdminChanged", "הרשאות הניהול שלך שונו");
        m.put("TjAccountLogAdminRemoved", "הרשאות הניהול שלך הוסרו");
        m.put("TjAccountLogRestricted", "הוגבלת");
        m.put("TjAccountLogBanned", "הוסרת");
        m.put("TjAccountLogLifted", "ההגבלות עליך הוסרו");
        m.put("TjAccountLogJoined", "הצטרפת");
        m.put("TjAccountLogLeft", "עזבת");
        m.put("TjAccountLogNewDevice", "מכשיר חדש התחבר");
        m.put("TjAccountLogBy", "על ידי %1$s");
        m.put("TjAccountLogChanged", "מה השתנה");
        m.put("TjFastDownloadInfo", "מבקש את הקבצים בחתיכות של 512KB, שש-עשרה במקביל, על פני ארבעה חיבורים במקום שניים - ושולח אותם על פני שמונה חיבורים במקום ארבעה. גודל החתיכה הוא ההגדרה המהירה של טלגרם עצמה, שהיא מפעילה לעצמה ורק לחלק מהמשתמשים; החיבורים הנוספים הם מה שמרים את התקרה כשהחתיכות כבר גדולות. המהירות עדיין מוגבלת מצד השרת והרשת שלך, אז הרווח משתנה. כבה את זה אם ההעברות נהיות איטיות או נתקעות.");
        ...
        m.put("TjWatchClearHistory", "ניקוי היסטוריית הצפייה");
        m.put("TjWatchClearHistoryInfo", "לשכוח את כל מה שברשימה, כולל המקום שכל אחד נעצר בו?");
        m.put("TjWatchSettings", "הגדרות צפייה");
        m.put("TjWatchKey", "מפתח TMDB");
        ...
        m.put("TjWatchKeyRetry", "נסיון נוסף");
        m.put("TjWatchFinished", "נצפה");
