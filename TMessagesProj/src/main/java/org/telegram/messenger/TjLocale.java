...
public class TjLocale {
    ...
    static {
        ...
        m.put("TjMediaCenter", "מרכז מדיה");
        m.put("TjMediaNewerPage", "פריטים חדשים יותר");
        m.put("TjMediaSelectType", "יש לבחור לפחות סוג מדיה אחד.");
        m.put("TjMediaYearHint", "שנה (לא חובה)");
        m.put("TjMediaWatchingFolders", "מעקב תיקיות · לחיצה לעצירה");
        m.put("TjMediaLocalCatalogUpdating", "הזיהוי המקומי מתעדכן; כותרים נוספים יופיעו עם התקדמות האינדקס");
        m.put("TjMediaFirstEpisodes", "חזרה לפרקים הראשונים");
        m.put("TjMediaNoIndexedEpisodes", "לא נמצאו פרקים לעונה הזאת במקורות שנוספו לאינדקס. אפשר לבחור עונה אחרת.");
        m.put("TjMediaLoadMore", "הצג עוד");
        m.put("TjMediaLocalTitle", "שם הסרט או הסדרה");
        m.put("TjMediaLocalIdentify", "שיוך מקומי ללא TMDB");
        m.put("TjMediaDownload", "הורדה");
        m.put("TjMediaDownloading", "מוריד…");
        m.put("TjMediaOnDevice", "זמין במכשיר הזה");
        m.put("TjMediaEpisodeConflict", "מספרי הפרקים סותרים זה את זה או מתייחסים לכמה פרקים. יש לבדוק את העונה והפרק לפני השיוך.");
        m.put("TjMediaSelectFolders", "בחירת תיקיות");
        m.put("TjMediaUnavailableFolder", "תיקייה לא זמינה");
        m.put("TjMediaFolderScopeInfo", "בחירת תיקייה מתעדכנת כשהצ׳אטים שבה משתנים. הכיסוי מתרחב כשטלגרם טוענת צ׳אטים; תיקייה ריקה או לא זמינה לעולם אינה בוחרת את כל הצ׳אטים. פריטים שכבר נוספו לאינדקס אינם נמחקים.");
        m.put("TjMediaSearchInfo", "החיפוש המקומי מתאים מילים ותחיליות של מילים בשמות קבצים, בכיתובים ובכותרים שזוהו. החיפוש בטלגרם עשוי להחזיר תוצאות שונות. פריטים ישנים הופכים לזמינים לחיפוש כשהם נוספים לאינדקס.");
        m.put("TjMediaSearchUpdating", "אינדקס החיפוש מתעדכן; התוצאות עשויות להיות חלקיות");
        ...
        m.put("TjMediaTab", "מדיה");
        m.put("TjMediaShowInDrawer", "הצג מרכז מדיה בתפריט הצד");
        m.put("TjMediaShowBottomTab", "הצג מדיה בסרגל התחתון");
        m.put("TjMediaKeyHint", "מפתח API או אסימון קריאה של TMDB");
        m.put("TjMediaRefresh", "רענן ספרייה");
        m.put("TjMediaClearIndex", "נקה את הספרייה המקומית של החשבון הזה");
        m.put("TjMediaAbout", "אודות מרכז המדיה");
        m.put("TjMediaIndexInfo", "האינדקס המקומי מכיל מדיה שכבר נטענה בספרייה. פריטים ישנים נוספים תוך כדי דפדוף. קבצים שהורדו נשמרים בנפרד מהאינדקס.");
        m.put("TjMediaClearIndexInfo", "לנקות את פריטי הספרייה, היסטוריית הצפייה, המועדפים, הרשימות וזיהויי הכותרים של החשבון הזה? הודעות בטלגרם וקובצי מדיה שהורדו לא יימחקו. לא ניתן לבטל את האיפוס המקומי.");
        m.put("TjMediaHome", "בית");
        m.put("TjMediaYourLibrary", "ספריית המדיה שלך");
        m.put("TjMediaRecentlyAdded", "נוספו לאחרונה");
        m.put("TjMediaSeeAll", "הצג הכול");
        m.put("TjMediaHomeEmpty", "המדיה מהמקורות שבחרת תופיע כאן. אפשר לעיין בשיחות או לשנות את בחירת המקורות.");
        m.put("TjMediaSeasons", "עונות ופרקים");
        m.put("TjMediaNextEpisode", "הפרק הבא הזמין");
        m.put("TjMediaNoNextEpisode", "לא נמצא באינדקס פרק ממוספר מאוחר יותר במקורות שנבחרו. סרוק את המקורות כדי למצוא פרקים נוספים, או בדוק את מספרי הפרקים.");
        m.put("TjMediaCompleted", "הניגון הושלם");
        m.put("TjMediaVersions", "גרסאות זמינות");
        m.put("TjMediaSeason", "עונה");
        m.put("TjMediaEpisode", "פרק");
        m.put("TjMediaUnknownEpisode", "קבצים ללא מספר פרק");
        m.put("TjMediaMovies", "סרטים");
        m.put("TjMediaSeries", "סדרות");
        m.put("TjMediaScan", "סריקת המקורות שנבחרו");
        m.put("TjMediaAutoMatch", "זיהוי סרטים וסדרות");
        m.put("TjMediaStopMatching", "עצירת הזיהוי");
        m.put("TjMediaAutoMatchInfo", "זיהוי סרטונים שכבר נוספו לספרייה מהמקורות שנבחרו באמצעות TMDB. רק שמות הכותרים שחולצו נשלחים. חשבונות ללא מפתח ידולגו, והתאמות לא ברורות יישארו ללא שינוי. אפשר לעצור בכל עת.");
        m.put("TjMediaAutoMatchProgress", "נבדקו %1$d · זוהו %2$d · לחץ לעצירה");
        m.put("TjMediaAutoMatchComplete", "נשמרו %1$d התאמות. פריטים שלא זוהו בוודאות נשארו זמינים לזיהוי ידני.");
        m.put("TjMediaStopScan", "עצירת סריקה");
        m.put("TjMediaScanInfo", "שמירת פרטי המדיה מהחשבונות והמקורות שנבחרו, כולל הודעות ישנות. קובצי המדיה לא יורדו. יש להשאיר את המסך פתוח; אפשר לעצור בכל עת. סריקת ספרייה גדולה עשויה לארוך זמן ולהשתמש בחבילת הגלישה.");
        m.put("TjMediaScanProgress", "עובדו %1$d פריטי מדיה · לחץ לעצירה");
        m.put("TjMediaScanComplete", "הסריקה הסתיימה. המדיה שנוספה זמינה בספרייה שלך.");
        m.put("TjMediaEditEpisode", "עריכת עונה ופרק");
        m.put("TjMediaEditEpisodeInfo", "השינוי נשמר רק בספרייה שלך. השאר שדה ריק כדי להשתמש שוב בשם הקובץ ובכיתוב.");
        m.put("TjMediaDetails", "פרטי מדיה");
        m.put("TjMediaIdentify", "זיהוי או תיקון כותר");
        m.put("TjMediaAutomaticMatch", "זוהה אוטומטית · לחץ לבדיקה או תיקון");
        m.put("TjMediaManageItem", "מועדפים, מצב צפייה ורשימות");
        m.put("TjMediaRemoveMatch", "הסר זיהוי כותר");
        m.put("TjMediaMetadata", "מידע על סרטים וסדרות");
        m.put("TjMediaMetadataInfo", "רשות: הזן מפתח API או אסימון קריאה של TMDB. שם הכותר שתבחר לחפש יישלח לשירות; השיחות ופרטי החשבון לא יישלחו. המפתח נשמר מוצפן במכשיר. שמור שדה ריק כדי לבטל.");
        m.put("TjMediaAttribution", "מוצר זה משתמש בממשק TMDB אך אינו מאושר או מוסמך על ידי TMDB.");
        m.put("TjMediaMetadataSaved", "הגדרות המידע נשמרו");
        m.put("TjMediaGetKey", "קבלת מפתח TMDB");
        m.put("TjMediaLookupInfo", "בדוק את שם הכותר לפני החיפוש. רק הטקסט הזה יישלח ל־TMDB.");
        m.put("TjMediaChooseMatch", "בחר את הכותר המתאים");
        ...
        m.put("TjMediaPlay", "ניגון");
        m.put("TjMediaOriginalCaption", "הכיתוב המקורי");
        m.put("TjMediaFileDetails", "פרטי הקובץ");
        m.put("TjMediaRestart", "ניגון מההתחלה");
        m.put("TjMediaHistory", "נצפו לאחרונה");
        m.put("TjMediaFavorites", "מועדפים");
        m.put("TjMediaWatched", "נצפו");
        m.put("TjMediaCollection", "רשימה אישית");
        m.put("TjMediaNewCollection", "יצירת רשימה חדשה");
        m.put("TjMediaRemoveCollection", "הסרה מהרשימה");
        m.put("TjMediaNoCollections", "עדיין אין רשימות. פתח פריט מדיה ובחר ברשימה אישית כדי ליצור אחת.");
        m.put("TjMediaIndexed", "מדיה שאונדקסה — זמינה לחיפוש ללא רשת");
        m.put("TjMediaOpenSource", "פתח את הודעת המקור");
        m.put("TjMediaFavorite", "הוסף למועדפים");
        m.put("TjMediaUnfavorite", "הסר מהמועדפים");
        m.put("TjMediaMarkWatched", "סמן כנצפה בספרייה");
        m.put("TjMediaUnwatched", "בטל סימון כנצפה בספרייה");
        m.put("TjMediaCollectionHint", "הזן שם רשימה. השאר ריק כדי להסיר את הפריט מהרשימה שלו.");
        m.put("TjMediaSaveError", "לא ניתן לשמור את השינוי בספרייה. נסה שוב.");
        m.put("TjMediaStateError", "הפריט השתנה או שלא ניתן לטעון את פרטיו המקומיים. רענן את הספרייה או פתח את ההודעה המקורית.");
        m.put("TjMediaCurrentAccount", "החשבון הנוכחי בלבד");
        m.put("TjMediaSelectAccounts", "בחירת חשבונות");
        m.put("TjMediaSources", "מקורות");
        m.put("TjMediaAllSources", "כל השיחות");
        m.put("TjMediaPrivate", "שיחות פרטיות");
        m.put("TjMediaGroups", "קבוצות");
        m.put("TjMediaChannels", "ערוצים");
        m.put("TjMediaSelectChats", "בחירת שיחות");
        m.put("TjMediaSelectAll", "בחר או נקה את כל המוצגים");
        m.put("TjMediaCenterDesc", "מדיה מהשיחות ומהחשבונות שלך");
        m.put("TjMediaSearch", "חיפוש בשמות קבצים ובכיתובים");
        ...
        m.put("TjMediaAccounts", "חשבונות");
        m.put("TjMediaAllAccounts", "כל החשבונות המחוברים");
        m.put("TjMediaLoading", "טוען מדיה…");
        m.put("TjMediaRetry", "חלק מהמקורות לא נטענו. לחץ לניסיון נוסף.");
        m.put("TjMediaMore", "טען מדיה נוספת");
        m.put("TjMediaEmpty", "לא נמצאה מדיה");
        m.put("TjMediaEnd", "כל התוצאות נטענו");
