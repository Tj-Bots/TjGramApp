...
public class TjLocale {
    ...
    static {
        ...
        m.put("TjFastDownloadInfo", "מבקש את הקבצים בחתיכות של 512KB ושמונה במקביל, במקום 128KB וארבע. אלה ההגדרות המהירות של טלגרם עצמה, שהיא מפעילה לעצמה ורק לחלק מהמשתמשים. המהירות עדיין מוגבלת מצד השרת, אז הרווח משתנה; כבה את זה אם ההורדות נהיות איטיות או נתקעות.");
