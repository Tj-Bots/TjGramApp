...
public class TjLocale {
    ...
    static {
        ...
        m.put("TjIdLookupCommon", "קבוצות משותפות");
        m.put("TjIdLookupNoCommon", "אין קבוצות משותפות");
        m.put("TjIdLookupRemove", "הסר מהקבוצה הזאת");
        m.put("TjIdLookupRemoveAll", "הסר מכל הקבוצות");
        m.put("TjIdLookupRemoveConfirm", "להסיר את %1$s מ-%2$s?");
        m.put("TjIdLookupRemoveConfirmAgain", "אי אפשר לבטל את זה. להסיר?");
        m.put("TjIdLookupRemoveAllConfirm", "להסיר את %1$s מכל %2$d הקבוצות המשותפות?");
        m.put("TjIdLookupRemoveAllConfirmAgain", "כל הקבוצות בבת אחת. בטוח?");
