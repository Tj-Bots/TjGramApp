...
public class TLParseException extends RuntimeException {
    ...
    /** Guarded: this runs on the network thread, before anything is certain to be ready. */
    private static boolean showProtocolErrors() {
        try {
            return org.telegram.messenger.tj.TjConfig.showProtocolErrors();
