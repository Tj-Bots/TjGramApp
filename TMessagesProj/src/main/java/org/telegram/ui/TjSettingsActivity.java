...
public class TjSettingsActivity extends BaseFragment {
    ...
    private static final int ID_TRANSLATE_BUTTON = 36;
    ...
    private static boolean isChecked(int id) {
        switch (id) {
            ...
            case ID_TRANSLATE_BUTTON: return TjConfig.messageTranslateButton();
    ...
    private static String keyFor(int id) {
        ...
        switch (id) {
            ...
            case ID_TRANSLATE_BUTTON: key = "message_translate_button"; break;
    ...
    private void updateItems() {
        ...
        items.add(new Item(VIEW_TYPE_CHECK, ID_TRANSLATE_BUTTON, TjLocale.getString(R.string.TjTranslateButton)));
